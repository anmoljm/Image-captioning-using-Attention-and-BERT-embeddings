...
word_map_file = '/home/ajawalimalli/im_attention/outputs_imatt/WORDMAP_coco_5_cap_per_img_5_min_word_freq.json'  # word map, ensure t's the same the data was encoded with and the model was trained with
